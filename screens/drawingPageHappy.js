...
export default class DrawingPageHappy extends Component {
  colors = ['#f3CE3E', '#f3CE3E', '#D7B699', '#6397CD', '#f3CE3E', '#f3CE3E', '#6397CD', 
'#f3CE3E', '#f3CE3E', '#6397CD', '#D7B699', '#D7B699'];
...
<Button
        ...
        >
          <SvgUri
            ...
            source={{ uri: "http://fe521db0.ngrok.io/dog1.svg" }}
          />
        </Button>
